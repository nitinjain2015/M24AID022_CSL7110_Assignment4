...
Exeeution INSTRUCTIONS : Ensure the jupyter notebook file (M24AID022_CSL7110_Assignment4.ipynb) and all data files as mentioned below for Q1, Q2, Q3 are in same folder before you execute the jupyter notebook
...
Q2 : small.txt, whole.txt

Q3 : actions.txt, answers.txt, files in folder - webpages
